...
const RentModal = () => {
  ...
  if (step === STEPS.LOCATION) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        ...
        <CountriesMap center={location?.latlng} />
      </div>
    );
  }
  ...
  if (step === STEPS.DESCRIPTION) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading title="How would you describe your place?" subtitle="Short and sweet work best" />
        <Input
          id="title"
          label="Title"
          disabled={isLoading}
